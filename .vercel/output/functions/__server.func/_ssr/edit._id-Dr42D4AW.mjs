...
import { d as Route, e as deleteTransactionFn, f as updateTransactionFn } from "./router-CKoNz1-i.mjs";
...
import { b as ChevronLeft, T as Trash2, e as Save } from "../_libs/lucide-react.mjs";
...
function EditTransactionPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PageShell, { title: "แก้ไขรายการ", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-cocoa", children: "แก้ไขรายการ" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", className: "text-destructive", onClick: handleDelete, disabled: loading, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-5 w-5" }) })
    ] }),
...
export {
  EditTransactionPage as component
};
